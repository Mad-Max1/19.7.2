...
def test_add_pets_with_valid_data(name='Cat1', animal_type='cat', age='3', pet_photo='images/cat1.jpg'):
...
def test_delete_pet():
    ...
    if len(my_pets['pets']) == 0:
        pf.add_new_pets(api_key, 'Barsik', 'cat', '3', 'images/cat1.jpg')
        _, my_pets = pf.get_list_of_pets(api_key, 'my_pets')
...
def test_add_pets_with_valid_data_without_photo(name='БарсикБезФото', animal_type='кот', age='2'):
...
def test_add_photo_at_pet(pet_photo='images/P1040103.jpg'):
...
def test_add_pet_negative_age_number(name='Cat1', animal_type='cat', age='-3', pet_photo='images/cat1.jpg'):
...
def test_add_pet_with_four_digit_age_number(name='Cat1', animal_type='cat', age='2048', pet_photo='images/cat1.jpg'):
...
def test_add_pet_with_a_lot_of_words_in_variable_name(animal_type='cat', age='2', pet_photo='images/cat1.jpg'):
    ...
    name = 'Инрике Хосе Иглесиас Фантазия кон чает пойду попью чаю мать вашу оу паир вайз'
...
def test_add_pet_with_special_characters_in_variable_animal_type(name='Cat1', age='3', pet_photo='images/cat1.jpg'):
...
def test_add_pet_with_numbers_in_variable_animal_type(name='Cat1', animal_type='2048', age='3',
...
def test_add_pet_with_a_lot_of_words_in_variable_animal_type(name='Cat1', age='2', pet_photo='images/cat1.jpg'):
    ...
    animal_type = 'Инрике Хосе Иглесиас Фантазия кон чает пойду попью чаю мать вашу оу паир вайз'
